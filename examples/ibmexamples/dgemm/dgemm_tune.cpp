...
#define LS
#ifdef LS
#define LOAD(p) svec4_d::load(p)
#define STORE(p, a) (a).store(p)
#else
#define LOAD(p) (*p)
#define STORE(p, a) (*p) = (a)
#endif
...
#if defined(SIMD)
   svec4_d v00, v10, v20, v30;
   svec4_d v01, v11, v21, v31;
   svec4_d v02, v12, v22, v32;
   svec4_d v03, v13, v23, v33;
#endif
...
#if defined(SIMD)
      for (j = n0; j < N; j+=4) {
         v00 = svec4_d(0); v10 = svec4_d(0); v20 = svec4_d(0); v30 = svec4_d(0);
         v01 = svec4_d(0); v11 = svec4_d(0); v21 = svec4_d(0); v31 = svec4_d(0);
         v02 = svec4_d(0); v12 = svec4_d(0); v22 = svec4_d(0); v32 = svec4_d(0);
         v03 = svec4_d(0); v13 = svec4_d(0); v23 = svec4_d(0); v33 = svec4_d(0);
         for (k = 0; k < K; k+=4) {
            svec4_d *A0 = (svec4_d *)&A[(i+0)*K+k];
            svec4_d *A1 = (svec4_d *)&A[(i+1)*K+k];
            svec4_d *A2 = (svec4_d *)&A[(i+2)*K+k];
            svec4_d *A3 = (svec4_d *)&A[(i+3)*K+k];
            svec4_d *B0 = (svec4_d *)&B[(j+0)*ldb+k];
            svec4_d *B1 = (svec4_d *)&B[(j+1)*ldb+k];
            svec4_d *B2 = (svec4_d *)&B[(j+2)*ldb+k];
            svec4_d *B3 = (svec4_d *)&B[(j+3)*ldb+k];
            v00 = svec_madd(LOAD(A0), LOAD(B0), v00);
            v10 = svec_madd(LOAD(A1), LOAD(B0), v10);
            v20 = svec_madd(LOAD(A2), LOAD(B0), v20);
            v30 = svec_madd(LOAD(A3), LOAD(B0), v30);
            v01 = svec_madd(LOAD(A0), LOAD(B1), v01);
            v11 = svec_madd(LOAD(A1), LOAD(B1), v11);
            v21 = svec_madd(LOAD(A2), LOAD(B1), v21);
            v31 = svec_madd(LOAD(A3), LOAD(B1), v31);
            v02 = svec_madd(LOAD(A0), LOAD(B2), v02);
            v12 = svec_madd(LOAD(A1), LOAD(B2), v12);
            v22 = svec_madd(LOAD(A2), LOAD(B2), v22);
            v32 = svec_madd(LOAD(A3), LOAD(B2), v32);
            v03 = svec_madd(LOAD(A0), LOAD(B3), v03);
            v13 = svec_madd(LOAD(A1), LOAD(B3), v13);
            v23 = svec_madd(LOAD(A2), LOAD(B3), v23);
            v33 = svec_madd(LOAD(A3), LOAD(B3), v33);
         }
         nindex0 = nind[j+0];
         nindex1 = nind[j+1];
         nindex2 = nind[j+2];
         nindex3 = nind[j+3];
         svec4_d *C00 = (svec4_d *)&C[mindex0+nindex0];
         svec4_d *C10 = (svec4_d *)&C[mindex1+nindex0];
         svec4_d *C20 = (svec4_d *)&C[mindex2+nindex0];
         svec4_d *C30 = (svec4_d *)&C[mindex3+nindex0];

         //do parallel merge and get 4 svec4_d.
         svec4_d s00 = svec_preduce_add(v00, v01, v02, v03);
         svec4_d s10 = svec_preduce_add(v10, v11, v12, v13);
         svec4_d s20 = svec_preduce_add(v20, v21, v22, v23);
         svec4_d s30 = svec_preduce_add(v30, v31, v32, v33);

         STORE(C00, LOAD(C00) + s00);
         STORE(C10, LOAD(C10) + s10);
         STORE(C20, LOAD(C20) + s20);
         STORE(C30, LOAD(C30) + s30);
      }
#else
      for (j = n0; j < N-3; j+=4) {
