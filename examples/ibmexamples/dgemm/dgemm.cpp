      ...
      for (j = n0; j < N; j+=4) {
        ...
        v03 = svec4_d(0); v13 = svec4_d(0); v23 = svec4_d(0); v33 = svec4_d(0);
         for (k = 0; k < K; k+=4) {
            ...
            v00 = svec_madd(*A0, *B0, v00);
            v10 = svec_madd(*A1, *B0, v10);
            v20 = svec_madd(*A2, *B0, v20);
            v30 = svec_madd(*A3, *B0, v30);
            v01 = svec_madd(*A0, *B1, v01);
            v11 = svec_madd(*A1, *B1, v11);
            v21 = svec_madd(*A2, *B1, v21);
            v31 = svec_madd(*A3, *B1, v31);
            v02 = svec_madd(*A0, *B2, v02);
            v12 = svec_madd(*A1, *B2, v12);
            v22 = svec_madd(*A2, *B2, v22);
            v32 = svec_madd(*A3, *B2, v32);
            v03 = svec_madd(*A0, *B3, v03);
            v13 = svec_madd(*A1, *B3, v13);
            v23 = svec_madd(*A2, *B3, v23);
            v33 = svec_madd(*A3, *B3, v33);
         }
         nindex0 = nind[j+0];
         nindex1 = nind[j+1];
         nindex2 = nind[j+2];
