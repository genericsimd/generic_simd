...
int enqueue_arq_fragq(frag_queue* fragq, int frame_num, int cid, logical_element * frag, u_int8_t is_order, int rx_win_start, int arq_win_size, int bsn_modulo, u_int8_t is_mgt_con, sdu_queue* sduq);

int enqueue_fragq(frag_queue* fragq, int frame_num, int cid, logical_element* frag, int bsn_modulo,u_int8_t is_mgt_con, sdu_queue* sduq);
