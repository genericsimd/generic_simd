...
#define T7_DURATION 1000000 // in usec (=1s)
#define T8_DURATION 300000 // in usec (=300ms)
#define T10_DURATION 1000000 // in usec (=1sec), maximum 3sec
#define T14_DURATION 200000 // in usec (=200msec)
