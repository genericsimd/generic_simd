...
extern int param_UL_IS_FRAG_ENABLED; // is FRAGMENTATION enabled (holds for all UGS and BE cids)
extern int param_UL_IS_PACK_ENABLED; // is PACKING enabled (holds for all UGS and BE cids)
...
extern int param_UL_CBR_PACKET_SIZE;
extern int param_UL_CBR_PACKET_DELAY;

extern int param_FHDC_FLAG;
extern int param_DL_STC_MATRIX_TYPE;
extern int param_UL_STC_MATRIX_TYPE;

extern int param_RANGING_POWER_THD;

extern unsigned long long int param_KEY_LIFE_DURATION;
extern unsigned long long int param_KEY_GRACE_TIME;
extern unsigned long long int param_KEY_DELTA_ADD;
