...
int parse_burst_pdu(unsigned int frame_num, u_char* burst, unsigned short bur_cid, int length, pdu_frame_queue* ul_pduq,  ul_br_queue* brqlist, mgt_msg_queue *ul_msgq);
