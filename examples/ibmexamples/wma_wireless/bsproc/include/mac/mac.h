...
//#define AMC_ENABLE
#define CRC_ADJUST_ENABLE

//#define AMC_TEST

//#define DSX_ENABLE	/* option to enable dsa/dsd/dsd */

#ifdef DSX_ENABLE
#define DSA_SPONSOR	/* option to be dsa transaction sponsor, ss and bs can't be both enabled*/
//#define DSA_TEST	/* option to do dsa test */
//#define DSC_TEST	/* option to do dsc test */
//#define DSD_TEST	/* option to do dsd test */
#endif
...
#define MAX_SDU_IN_CID_QUEUE 1048576
#define MAX_CID_QUEUE_SIZE 32768 // 32kB
