...
*
*  Function: RRH Monitoring Protocol, Private Protocol according "IBM RRU C&M Message"
*
*  
*  Data:    2011-03-14
*  Modify:
...
#define RRH_SEND_BUF_MAX_LEN        (1024*10)
#define RRH_REV_BUF_MAX_LEN          (1024*10)


#define RRH_HEARTBEAT_TIMEOUT_NUM        9

/**/
#define RRH_MAX_PROTOCOL_BODY_LEN                      256

/**/
#define RRH_LONGITUDE                    "103.12345678"
#define RRH_LATITUDE                        "23.1234567"
...
#define RRH_MSG_CHAN1_RX_BB_LEN                   16

/* Channel 2 RX BB,1.1M RN , AD, 12M RN*/
#define RRH_MSG_CHAN2_RX_BB                    (0x515)
#define RRH_MSG_CHAN2_RX_BB_LEN                   16
...
struct trans_rrh_send_msg_info
{
    ...
    struct timeval expired_tv;       /*time out */
    u_int32_t   uw_src_moudle;   /*Sender*/
    u_int8_t     uc_block_flag;      /*Block message or noblock message*/
    /*
    union 
    {
...
struct trans_rrh_resp_msg_result
{
    u_int8_t     uc_result;  /*enum trans_ack_flag_enum*/
    fun_callback f_callback;
    u_int32_t   uw_len;                /*Length of p_response_msg*/    
    u_int8_t  * p_result_msg;   /*(1)struct trans_timer_msg_info st_timer_info;*/    

};

#define SIZEOF_TRANS_RRH_RESP_MSG_RESULT    sizeof(struct trans_rrh_resp_msg_result)
...
extern u_int32_t trans_rrh_check_msg(u_int8_t *p_rev_msg, 
                            struct trans_rrh_resp_msg_result   *p_resp_result,
                            u_int32_t   *p_src_moudle);

extern u_int32_t trans_rrh_rev_msg(u_int8_t *p_rev_msg, int32_t w_rrh_socket);

extern u_int32_t trans_rrh_rev_msg_process(u_int8_t *p_rev_msg, u_int8_t *p_send_msg, 
                           struct trans_thread_info *p_thread_info);
extern void trans_rrh_rev_heartbeat_process(void );
extern u_int32_t trans_rrh_rev_config_process(u_int8_t *p_rev_msg, u_int8_t *p_send_msg, 
                           struct trans_thread_info *p_thread_info);
extern u_int32_t trans_rrh_rev_query_process(u_int8_t *p_rev_msg, u_int8_t *p_send_msg, 
                           struct trans_thread_info *p_thread_info);                              
extern u_int32_t trans_rrh_rev_alarm_process(u_int8_t *p_rev_msg, u_int8_t *p_send_msg, 
                           struct trans_thread_info *p_thread_info);
extern u_int16_t  trans_rrh_cal_crc16(u_int8_t *p_buf, u_int16_t us_len);
extern u_int16_t  trans_rrh_get_crc16(u_int8_t *p_buf, u_int16_t us_len); 

extern u_int16_t  trans_rrh_cal_serial_num(); 


extern u_int32_t trans_rrh_send_msg_process(struct trans_rrh_send_msg_info *p_info);

extern u_int32_t trans_rrh_build_msg(struct trans_rrh_build_msg_info *p_build_info, 
                                    u_int8_t *p_send_msg, u_int32_t *p_msg_len, u_int16_t *p_serial_number);
                                    
extern u_int32_t trans_rrh_build_body(struct trans_rrh_build_msg_info *p_build_info, u_int32_t uw_param_num,
                                    u_int8_t *p_send_body, u_int32_t *p_body_len);

extern u_int32_t trans_rrh_build_heard(struct trans_rrh_build_msg_info *p_build_info, 
                                    u_int8_t *p_send_head, u_int32_t uw_body_len, u_int16_t *p_serial_number);


//extern int trans_rrh_send_msg_timer_func(void *p_msg, size_t len, void *p_msg_info);
extern int trans_rrh_block_msg_timer_func(void *p_msg, size_t len, void *p_msg_info);

extern int trans_rrh_noblock_msg_timer_func(void *p_msg, size_t len, void *p_msg_info);

extern int trans_rrh_heartbeat_timer_func(void *p_msg, size_t len, void *p_msg_info);
extern int trans_rrh_metric_timer_func(void *p_msg, size_t len, void *p_msg_info);


extern u_int32_t trans_rrh_send_msg_ch_mode(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_ch_flag(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_ch_freq(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_dl_pre_time(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_tx_len(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_rx_len(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_pa_switch(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_agc(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_ch_rx_pgc(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_gps_enable(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_output_pow(u_int8_t *p_msg, u_int8_t uc_num, void *p_value);

extern u_int32_t trans_rrh_send_msg_q_gps(u_int8_t *p_msg);

extern u_int32_t trans_rrh_send_msg_q_power(u_int8_t *p_msg);

extern u_int32_t trans_rrh_send_msg_q_gps_lock(u_int8_t *p_msg, void *p_value);

extern u_int32_t trans_rrh_send_action_query(
                            struct trans_send_query_to_rrh *p_query_rrh,
                            size_t len,
                            u_int8_t * p_send_msg);

extern u_int32_t trans_rrh_send_monitor_query(
                            struct trans_send_query_to_rrh *p_query_rrh,
                            size_t len,
                            u_int8_t * p_send_msg);

extern u_int32_t trans_rrh_send_agent_query(
                            struct trans_send_query_to_rrh *p_query_rrh,
                            size_t len,
                            u_int8_t * p_send_msg);

extern u_int32_t trans_rrh_send_wireless_query(
                            struct trans_send_query_to_rrh *p_query_rrh,
                            size_t len,
                            u_int8_t * p_send_msg);

extern u_int32_t trans_rrh_send_action_cfg(
                            struct trans_send_cfg_to_rrh *p_cfg_rrh,
                            size_t len,
                            u_int8_t * p_send_msg);


extern u_int32_t trans_rrh_send_monitor_cfg(
                            struct trans_send_cfg_to_rrh *p_cfg_rrh,
                            size_t len,
                            u_int8_t * p_send_msg);

extern u_int32_t trans_rrh_send_agent_cfg(
                            struct trans_send_cfg_to_rrh *p_cfg_rrh,
                            size_t len,
                            u_int8_t * p_send_msg);

extern u_int32_t trans_rrh_send_wireless_cfg(
                            struct trans_send_cfg_to_rrh *p_cfg_rrh,
                            size_t len,
                            u_int8_t * p_send_msg);
...
#if 0
extern u_int32_t trans_rrh_msg_en_quene(void *p_msg, struct rrh_en_queue_msg *p_en_quene);
extern u_int32_t trans_rrh_msg_de_quene(u_int8_t *p_result);


extern u_int32_t trans_rrh_send_msg_metric(u_int8_t  *p_send_msg, 
                                             struct trans_rrh_metric_info *p_metric_info);

extern u_int32_t trans_rrh_get_metric_param(int w_agent_metric_id,
                                                                u_int16_t *p_rrh_metric_id, 
                                                                u_int8_t *p_rrh_metric_len);


extern u_int32_t trans_rrh_forward_agent_metric(u_int8_t  *p_send_msg, 
                            struct trans_agent_metric_info *p_agent_metric_info);

extern u_int32_t trans_rrh_forward_rrh_metric(u_int8_t  *p_send_msg, int32_t w_sockfd,
    struct trans_agent_metric_info *p_agent_metric, u_int32_t uw_metric_id, int32_t w_metric_value);

extern u_int32_t trans_rrh_get_agent_metric_id(u_int32_t uw_rrh_metric_id,
...
//extern struct sem_handle * g_trans_rrh_msg_sem;
