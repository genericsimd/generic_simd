...
#define REVS(n) (((unsigned short)((n) & 0xff)) << 8 | (((n) & 0xff00) >> 8))
#define REVL(n) ((((unsigned int)((n) & 0xff)) << 24) | ((unsigned int)((n) & 0xff00)) << 8 | ((unsigned int)((n) & 0xff0000)>>  8 | ((unsigned int)((n)&0xff000000)>>24)))
#else
#define REVS(n) (n)
#define REVL(n) (n)
#endif
